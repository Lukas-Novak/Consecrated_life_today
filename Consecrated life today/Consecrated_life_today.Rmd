...
vars.prev.tab = data %>% 
  ...
  mutate(sec_Source = dplyr::recode(sec_Source,
                                    "1" = "Sample 1",
                                    "2" = "Sample 2",
                                    "4" = "Sample 3")) # it ok to name it like this here
...
```{r Print regres tab 2, echo=FALSE, message=FALSE, warning=FALSE}
  knitr::kable(tab2.b, "latex", booktabs=T, linesep = "", caption = "Depicts associations (in Odds rations) between living in clerical life and health complains in the last month (Sample 2 and 4)") %>% 
  kableExtra::kable_styling(latex_options = c("scale_down","hold_position"),   font_size = 7) %>%  # full_width = T or longtable = T (to the Kable command)

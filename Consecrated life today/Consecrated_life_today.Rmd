...
## Statistical analysis
  ...
  To explore differences in health status among clerics and non - clerics, we compared in logistic regression models long lasting illnesses of clerics to reported long lasting illnesses of participants from representative sample. In these models, reported long lasting illness was was as a dependent variable, grouping variable distinguishing clerics from non - clerics was regressor and covariates were are, gender, education and length of a life in clerical order. Proportional odds model was used to compare clerincs and non - clerics to composite variable created as summ of all illnesses and reflecting general health. The same method was applied to explore associations between chronotype and chronic illnesses and helth complains in clerics. Proportional odds assumption in each of the ordinal regression model by the Brant test and it was suggested that this assumption hodls for each model. Multicolineariy was assessed by variance inflation factor (VIF) and its results (VIF < 10 [@TAY2017]) did not suggest multicolinearity.    
...
* další krok spočítat dvě série ordinální regrese pro chronotyp a chronická onemocnění - předešlé se tedy asi nepoužije

...
\caption{\label{tab:Print regres tab 2}Depicts associations (in Odds rations) between living in clerical life and health complains in the last month (Sample 2 and 4)}
\centering
\resizebox{\linewidth}{!}{
\fontsize{7}{9}\selectfont
\begin{threeparttable}
